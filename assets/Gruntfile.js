	...
	grunt.initConfig( {
		uglify: {
			...
			specific:{
				files: [{
					expand  : true,
					cwd     : 'js/specific/',
					src     : ['**/*.js', '!**/script.js', '**/script.js', '!**/_*.min.js'],
					dest    : 'js/specific/',
					ext     : '.min.js',
					rename  : function( dest, src ){
						var pathSplit = src.split( '/' );
		...
		cssmin: {
			specific: {
				expand : true,
				cwd    : 'css/',
				src    : [ 'specific/**/*.css', '!specific/**/*.less.css', 'specific/**/*.less.css', '!**/_*.min.css' ],
				ext    : '.min.css',
				dest   : 'css/',
				rename : function( dest, src ){
					var pathSplit = src.split( '/' );
		...
		//       { expand: true, src: ['css/**/fonts/**' ], dest: '../../website/assets' },
